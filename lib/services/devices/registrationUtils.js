...
function sendRegistrations(entityType, unregister, deviceData,token, callback) {

    var options = ngsiService.createRequestObject('/NGSI9/registerContext', deviceData, token);
