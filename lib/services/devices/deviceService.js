...
function registerDevice(deviceObj, callback) {
    ...
    function completeRegistrations(error, deviceData) {
        ...
        async.waterfall([
            apply(registrationUtils.sendRegistrations, deviceData.id, deviceData.service, deviceData.subservice, false, deviceData),
        ...
        async.waterfall([
            ...
            if (error) {
                ...
                async.waterfall([
                    ...
                    processUnsubscribes,
                    apply(registrationUtils.sendRegistrations,  mergedDevice.id, mergedDevice.service, mergedDevice.subservice, true, mergedDevice),
...
function updateRegisterDevice(deviceObj, callback) {
    ...
    async.waterfall([
        ...
        apply(registrationUtils.sendRegistrations, deviceObj.id, deviceObj.service, deviceObj.subservice, false),
