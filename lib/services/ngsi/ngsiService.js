...
function findConfigurationGroup2(deviceObj, callback) {
    function handlerGroupFind(error, group) {
        ...
        logger.debug(context, "Busca de config grups");
...
function executeWithDeviceInformation(operationFunction) {
    function authenticate(deviceInformation, typeInformation, callback){
    ...
    return function(entityId, service, subservice, attributes, deviceInformation, callback) {
        ...
        async.waterfall([
            apply(findConfigurationGroup2,deviceInformation),//return the configuration of group
...
exports.executeWithDeviceInformation = (context, executeWithDeviceInformation);
