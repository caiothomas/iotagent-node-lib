...
function getToken(trust, callback) {
    var options = {
        url:  config.getConfig().authentication.protocol + config.getConfig().authentication.host + ':' + config.getConfig().authentication.port +
           config.getConfig().authentication.path,    
        method: 'POST',
        json: {
            auth: {
                identity: {
                    ...
                    password: {
                        user: {
                            domain: {
                                name: config.getConfig().authentication.domain
                            },
